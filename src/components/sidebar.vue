  ...
  <nav>
    <v-app-bar app color="#2d2f90">
      ...
      <v-toolbar-title class="text-subtitle-1 black--text">
        <v-row no-gutters>
          <v-col cols="12">
            <img class="py-1" height="60px" src="pan.png" />
          </v-col>
        </v-row>
      </v-toolbar-title>
      <v-spacer></v-spacer>
    ...
    <v-navigation-drawer app v-model="sidebar" color="#2d2f90">
      <v-list>
        <v-card class="ma-6">
      ...
      <v-list>
        <v-list-item active-class="white--text" to="/dashboard">
          <v-list-item-icon>
      ...
      <v-list>
        <v-list-item active-class="white--text" to="/hasil_suara">
          <v-list-item-icon>
